...
### Schema:
it is a namespace or a container within a database

in this example we see two table with same name both within the same database but inside different Schemas;


![](../../assets/schema_with_two_tables.png)



### Task 13
This is a sample demo to the maven project.

[Link to PostgreSQL Demo](../../source_code/Spring_Framework/jdbc-postgres-demo)
